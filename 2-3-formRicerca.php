...
<html lang="it">
	...
	<body>
		...
		<form method="post" action="2-4-ricercaEventiXML.php">
			<fieldset>
				...
				<input type="radio" name="r10" id="r1_2" value="teatro"><label for="r1_2">Teatro</label><br>
				<input type="radio" name="r11" id="r1_3" value="sport"><label for="r1_3">Sport</label><br>
				<input type="radio" name="r12" id="r1_4" value="%"><label for="r1_4">Tutti</label><br>
				<br><br>				
